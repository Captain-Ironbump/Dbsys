...
values(utl_raw.cast_to_raw('https:\\something.pdf'), 1);
insert into Bild(Bild, Wohnungsnummer)
values(utl_raw.cast_to_raw('https:\\something.pdf'), 2);
insert into Bild(Bild, Wohnungsnummer)
values(utl_raw.cast_to_raw('https:\\something.pdf'), 3);
insert into Bild(Bild, Wohnungsnummer)
values(utl_raw.cast_to_raw('https:\\something.pdf'), 4);
/* F�r Aufgabe 5c) */
insert into Bild(Bild, Wohnungsnummer)
values(utl_raw.cast_to_raw('https:\\something.pdf'), 7);
