...
CREATE VIEW KundenempfehlungenOne AS
...
CREATE VIEW KundenempfehlungenTwo AS
SELECT k.Mailadresse, f.Wohnungsnummer, b.Rating
FROM Kunde k
INNER JOIN Buchung b ON k.Mailadresse = b.Mailadresse
INNER JOIN Ferienwohnung f ON b.Wohnungsnummer = f.Wohnungsnummer
...
FROM KundenempfehlungenOne K1
INNER JOIN KundenempfehlungenTwo K2 ON K1.Wohnungsnummer = K2.Wohnungsnummer AND K1.Rating = K2.Rating
